...
public class Ex2DynamicRegForm extends Ex2RegistrationFormGUI
{
      ...
      Ex2RegistrationFormGUI formGUIObject;
                         ...
                         try{ 
                            ...
                            if (ae.getSource() == registerButton) { 
                               ...
                               //Executing MySQL Update Query 
                                ...
                                rstLast = stmt.executeQuery("select *from regform1"); 
                        ...
                        JOptionPane.showMessageDialog(idField,"Please select Gender");                  
                              ...
                              { 
                                 ...
                                 if(male.isSelected()) 
                                    ...
                                    updatePreStmt = con.prepareStatement("update regform1 set name=?,gender=?,address=?,contact=?where id="+id); 
            ...
            deleteButton.addActionListener(new AbstractAction(SHOW){ 
              ...
              public void actionPerformed(ActionEvent e){ 
                  ...
                  if(r>=0){ 
                        ...
                        if (JOptionPane.showConfirmDialog(panel,"Are you sure want to Delete this 'RECORD' ?","WARNING",JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION)
                        { 
                              ...
                              int i = stmt.executeUpdate("delete from regform1 where id="+id); 
 ...
 //@Override 
      ...
      private void addRows(){ 
            ...
            rst = stmt.executeQuery("select *from regform1"); 
